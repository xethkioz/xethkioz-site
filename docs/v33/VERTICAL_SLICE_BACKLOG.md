# WORLD OF XETHKIOZ — Vertical Slice v3.3 Backlog

## P0 — playable core
- [x] Dedicated v3.3 branch
- [x] Modular core state/events/save
- [x] 8-direction movement + dash
- [x] Basic melee hit query
- [x] Enemy chase/attack/death
- [x] XP + levels
- [x] Xethkioz follower placeholder
- [x] HUD placeholder
