  ...
  theme: {
    extend: {
      colors: {
        ...
        fusionBg: '#050608',
        fusionSurface: { DEFAULT: '#0F1118', base: '#0F1118', muted: '#1A1D26', glow: '#242836', panel: '#16141F' },
        fusionAccent: {
          tech: { primary: '#8A2EFF', secondary: '#FF7A00' },
          gaming: '#8A2EFF',
          fun: '#FF7A00',
          science: '#3B82F6',
          greenNode: '#32FF8A',
      ...
      boxShadow: {
        'glow-tech': '0 0 34px rgba(138,46,255,0.28), 0 0 90px rgba(138,46,255,0.12)',
        'glow-tech-subtle': '0 0 22px rgba(138,46,255,0.16)',
        'glow-action': '0 0 34px rgba(255,122,0,0.28), 0 0 90px rgba(255,122,0,0.1)',
        'glow-science': '0 0 34px rgba(59,130,246,0.28), 0 0 90px rgba(59,130,246,0.1)',
        'glow-green': '0 0 34px rgba(50,255,138,0.30), 0 0 90px rgba(50,255,138,0.14)',
      },
