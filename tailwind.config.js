  ...
  theme: {
    extend: {
      colors: {
        ...
        fusionBg: '#0B0A0F',
        fusionSurface: { base: '#16141F', muted: 'rgba(255,255,255,0.08)', glow: '#211B34' },
        fusionAccent: {
          tech: { primary: '#8B5CF6', secondary: '#FF7E29' },
          science: '#38BDF8',
          greenNode: '#22C55E',
          secret: '#EAB308',
        },
      ...
      boxShadow: {
        'glow-tech': '0 0 34px rgba(139,92,246,0.28), 0 0 90px rgba(139,92,246,0.12)',
        'glow-tech-subtle': '0 0 22px rgba(139,92,246,0.16)',
        'glow-action': '0 0 34px rgba(255,126,41,0.28), 0 0 90px rgba(255,126,41,0.1)',
        'glow-science': '0 0 34px rgba(56,189,248,0.28), 0 0 90px rgba(56,189,248,0.1)',
        'glow-green': '0 0 34px rgba(34,197,94,0.28), 0 0 90px rgba(34,197,94,0.12)',
      },
