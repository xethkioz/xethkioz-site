...
export default async function handler(_request: any, response: any) {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?>\n<rss version="2.0"><channel><title>XETHKIOZ // Nexus News</title><link>${SITE_URL}/news</link><description>Gaming, ciencia, tecnología, humor y archivos Green Node conectados por la Red de Portales XETHKIOZ.</description><language>es-ar</language><lastBuildDate>${new Date().toUTCString()}</lastBuildDate>${items.join('')}</channel></rss>`
