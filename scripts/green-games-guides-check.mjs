...
add('Fun defaults to Huellas while preserving explicit Nexus access', fun.includes("const MASCOTAS_URL = '/mascotas/'") && fun.includes('return <MascotasRedirect />') && fun.includes("location.hash === '#nexus-city'") && fun.includes("get('mode') === 'play'"), 'The retired meme gateway must lead to same-origin Huellas while keeping the legacy Nexus entrance intentional.')
