...
add('Meme Core renders one focused section at a time', ['arcade', 'clips', 'wall'].every((section) => fun.includes(`activeMemeSection === '${section}'`)) && !fun.includes("activeMemeSection === 'home'") && fun.includes('xk-meme-section-nav'), 'Arcade, clips and the wall must not remain in one oversized page.')
