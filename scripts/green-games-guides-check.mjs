...
add('Nexus City is a first-class lazy portal', fun.includes("const NexusCity = lazy(() => import('./NexusCity'))") && fun.includes('<NexusCity />') && !fun.includes('MascotasRedirect') && app.includes('<Route path="/fun" element={<Navigate to="/nexus-city" replace />} />'), 'The retired Fun alias must redirect to the dedicated Nexus City route without mounting Huellas.')
