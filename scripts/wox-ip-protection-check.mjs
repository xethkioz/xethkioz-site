...
const requiredWebArt = ['player-etereo-sigil.svg','xethkioz-resonance-sigil.svg','veyr-green-sigil.svg','biome-izrdralar.svg','biome-desfralar.svg','biome-xiomalar.svg','biome-zodnight.svg']
const files = []
