...
check('home exposes the localized web creation feature', home.includes("localizePath('/creacion-web')") && home.includes("lang === 'es' ? 'CREACIÓN WEB' : 'WEB CREATION'"))
...
check('home preserves the compact XETHKIOZ ecosystem navigation', home.includes("localizePath('/gaming')") && home.includes('https://argenciencia.com/') && home.includes('href="/mascotas/"') && home.includes("localizePath('/nexus-city')") && home.includes("localizePath('/creacion-web')") && home.includes('to="/news"'))
check('home separates ecosystem navigation from the World experience', home.includes('className="wox-ecosystem-nav"') && home.includes('className="wox-hero"') && home.includes('className="wox-content"'))
check('home uses responsive protected media without exposing editable 3D assets', home.includes('className="wox-bg"') && home.includes('/assets/bg-dragon-poster.webp') && home.includes('/assets/bg-dragon-animated.mp4') && home.includes('prefers-reduced-motion: reduce') && homeCss.includes('.wox-bg') && homeCss.includes('@media(max-width:760px)') && !home.includes('.glb'))
