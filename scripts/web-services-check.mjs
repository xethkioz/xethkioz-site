...
check('home restores three primary magical portals', home.includes("frame: '/assets/portal-games-clean-v1.webp'") && home.includes("frame: '/assets/portal-science-clean-v1.webp'") && home.includes("frame: '/assets/portal-fun-chaos-v2.webp'") && home.includes('className="xk-rb-portals"') && homeCss.includes('grid-template-columns:.88fr 1.16fr .88fr'))
