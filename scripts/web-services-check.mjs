...
check('home reserves responsive media slots for approved 3D assets', home.includes('MediaPlaceholder') && homeCss.includes('.wox-media-placeholder') && homeCss.includes('@media(max-width:760px)'))
