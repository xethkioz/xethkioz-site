...
check('home uses responsive protected media without exposing editable 3D assets', home.includes('className="wox-bg"') && home.includes('/assets/portal-games-world-v3.webp') && !home.includes('<video') && homeCss.includes('prefers-reduced-motion: reduce') && homeCss.includes('.wox-bg') && homeCss.includes('@media(max-width:760px)') && !home.includes('.glb'))
