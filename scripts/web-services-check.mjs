...
check('mobile Wisp is rendered below xl', home.includes('<CompactWispPortal') && home.includes('xl:hidden') && home.includes('/assets/green-wisp.png'))
...
check('quote API keeps service role server-side', api.includes('process.env.SUPABASE_SERVICE_ROLE_KEY') && !page.includes('SUPABASE_SERVICE_ROLE_KEY'))
