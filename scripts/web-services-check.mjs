...
check('home exposes three primary magical portals', home.includes("frame: '/assets/portal-games-clean-v1.webp'") && home.includes("frame: '/assets/portal-science-clean-v1.webp'") && home.includes("world: '/assets/portal-mascotas-nature-v11-r2.webp'") && exists('public/assets/portal-mascotas-nature-v11-r2.webp') && home.includes("frame: '/assets/portal-fun-chaos-v2.webp'") && home.includes('className="xk-rb-portals"') && homeCss.includes('grid-template-columns:repeat(3,minmax(0,1fr))'))
