...
check('home exposes four primary magical portals', home.includes("frame: '/assets/portal-games-clean-v1.webp'") && home.includes("frame: '/assets/portal-science-clean-v1.webp'") && home.includes("world: '/assets/portal-comicon-world.svg'") && home.includes("frame: '/assets/portal-fun-chaos-v2.webp'") && home.includes('className="xk-rb-portals"') && homeCss.includes('grid-template-columns:.78fr 1.02fr 1.02fr .78fr'))
