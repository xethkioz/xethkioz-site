...
check('Veyr Wisp remains responsive and opens Green Node explicitly', globalWisp.includes('/assets/world-of-xethkioz/veyr/veyr-wisp-poster.webp') && globalWisp.includes("navigate('/green-node')") && globalWispCss.includes('@media (max-width: 767px)'))
