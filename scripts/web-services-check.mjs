...
check('home portal worlds stay proportional without duplicated copy or arch frames', home.includes('aspect-square') && home.includes('md:grid-cols-3') && home.includes('xk-home-portal-clean') && !home.includes('rounded-t-[42%]') && !home.includes('absolute inset-x-8 bottom-9'))
check('home portal atmosphere escapes card cuts and blends all three colors', home.includes('xk-home-portal-shell') && redesignCss.includes('portal-mist-pulse') && redesignCss.includes('rgba(139,92,246,.62)') && redesignCss.includes('rgba(34,211,238,.56)') && redesignCss.includes('rgba(251,146,60,.62)'))
