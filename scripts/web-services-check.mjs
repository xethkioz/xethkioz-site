...
check('home exposes the localized web creation feature', home.includes('<WebCreationFeature') && home.includes("to={localizePath('/creacion-web')}"))
...
check('home exposes four primary magical portals', home.includes("frame: '/assets/portal-games-clean-v1.webp'") && home.includes("frame: '/assets/portal-science-clean-v1.webp'") && home.includes("world: '/assets/portal-comicon-duality-v11.webp'") && exists('public/assets/portal-comicon-duality-v11.webp') && home.includes("world: '/assets/portal-mascotas-nature-v11-r2.webp'") && exists('public/assets/portal-mascotas-nature-v11-r2.webp') && home.includes("frame: '/assets/portal-fun-chaos-v2.webp'") && home.includes('className="xk-rb-portals"') && homeCss.includes('grid-template-columns:.78fr 1.02fr 1.02fr .78fr'))
...
check('Green Node Protect is public while Vault 13 remains gated', app.includes('function GreenNodeGate') && app.includes('function GreenNodeEntry') && app.includes('path="/green-node" element={<GreenNodeEntry />}') && app.includes('path="/green-node/vault" element={<GreenNodeGate />}'))
