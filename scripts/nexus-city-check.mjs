...
check('public Nexus entry is standalone', app.includes("const NexusCity = lazy(() => import('./pages/NexusCity'))") && app.includes('path="/nexus-city" element={<NexusCity />}'))
...
check('global and Home navigation', header.includes("to: '/mascotas/'") && home.includes("route: '/nexus-city'") && page.includes("id={embedded ? 'nexus-city' : undefined}"))
...
check('canonical integrated route', sitemap.includes("path: '/nexus-city'") && vercel.includes('\"source\": \"/nexus-city\"') && vercel.includes('\"destination\": \"/seo-shells/nexus-city.html\"') && seo.includes('SearchAction'))
