...
check('canonical integrated route', !sitemap.includes("'/nexus-city'") && vercel.includes('"source": "/nexus-city", "destination": "/fun#nexus-city", "permanent": true') && seo.includes('SearchAction'))
