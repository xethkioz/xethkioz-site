...
assert(privacy.includes('Analítica y el marketing están desactivados por defecto') && privacy.includes('Analytics and marketing are disabled by default'), 'The privacy policy must document the real default behavior in both languages.')
