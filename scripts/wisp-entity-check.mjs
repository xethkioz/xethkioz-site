...
add('Veyr editable GLB is not publicly shipped', !exists('public/assets/world-of-xethkioz/veyr/veyr-wisp-v03.glb'), 'The public web must ship only approved rendered media; editable 3D source stays private.')
