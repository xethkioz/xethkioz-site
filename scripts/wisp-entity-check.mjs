...
add('Veyr uses protected web art as the active global Wisp visual', globalWisp.includes('/assets/world-of-xethkioz/web-art/veyr-green-sigil.svg') && exists('public/assets/world-of-xethkioz/web-art/veyr-green-sigil.svg'), 'The public Wisp must use transformed web art, never the clean production render.')
add('Raw Veyr GLB is excluded from the public package', !exists('public/assets/world-of-xethkioz/veyr/veyr-wisp-v03.glb'), 'Production geometry stays outside the deployable web tree.')
