...
add('Green Wisp remains hidden route access', ((home.includes('<FusionWispEntity') || worldStage.includes('<FusionWispEntity')) && wispEntity.includes("'/green-node'")) || (home.includes('green-wisp-secret') && home.includes('to="/green-node"')), 'Wisp must remain an Easter Egg access path to Green Node.')
