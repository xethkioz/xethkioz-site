...
add('Public routes remain scoped', ['/gaming', '/science', '/fun', '/green-node'].every((route) => app.includes(`path="${route}"`)) && !app.includes('path="/comicon"'), 'Expected public routes are present and COMICON is absent.')
