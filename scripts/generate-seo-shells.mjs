...
const spanishRoutes = [
  ...
  },
  {
    file: 'fun.html',
    path: '/nexus-city',
    title: 'Nexus City | Comunidad, perfiles y cultura digital | XETHKIOZ',
    description: 'Perfiles, comunidad, clips, humor y espacios sociales conectados dentro de Nexus City.',
    keywords: 'Nexus City, comunidad gamer, perfiles, clips, humor, cultura digital, XETHKIOZ',
...
const englishRoutes = [
  ...
  },
  {
    file: 'en-fun.html',
    path: '/en/nexus-city',
    title: 'Nexus City | Community, Profiles and Digital Culture | XETHKIOZ',
    description: 'Profiles, community, clips, humor and connected social spaces inside Nexus City.',
    keywords: 'Nexus City, gaming community, profiles, clips, humor, digital culture, XETHKIOZ',
    image: '/assets/portal-fun-world-v3.webp',
