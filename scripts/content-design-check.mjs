...
check('Home uses the new optimized COMICON and Mascotas portal scenes', home.includes("world: '/assets/portal-comicon-duality-v11.webp'") && home.includes("world: '/assets/portal-mascotas-nature-v11.webp'") && fs.existsSync(path.join(root, 'public/assets/portal-comicon-duality-v11.webp')) && fs.existsSync(path.join(root, 'public/assets/portal-mascotas-nature-v11.webp')))
