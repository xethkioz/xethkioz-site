...
check('Home exposes three compact public portals', home.includes("localizePath('/gaming')") && home.includes('https://argenciencia.com/') && home.includes('href="/mascotas/"') && !home.includes("id: 'comicon'"))
check('Home is centered on World of Xethkioz', home.includes('world-of-xethkioz-logo.svg') && home.includes('EXPLORAR EL JUEGO') && home.includes("localizePath('/world-of-xethkioz')") && !home.includes('EL GAMING ES'))
