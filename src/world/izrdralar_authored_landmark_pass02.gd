...
func _build_house_integration(root: Node2D) -> void:
	var s := visual_scale
	_add_polygon(root, [Vector2(-53, 18), Vector2(53, 18), Vector2(46, 32), Vector2(-46, 32)] * s, Color("69513d"), -4)
	_add_polygon(root, [Vector2(-17, 17), Vector2(17, 17), Vector2(14, 28), Vector2(-14, 28)] * s, Color("9b7450"), -2)
	_add_polygon(root, [Vector2(-50, 20), Vector2(-30, 20), Vector2(-32, 28), Vector2(-52, 28)] * s, Color("315f3f"), -2)
	_add_polygon(root, [Vector2(30, 20), Vector2(50, 20), Vector2(52, 28), Vector2(32, 28)] * s, Color("315f3f"), -2)
...
func _build_sanctuary_integration(root: Node2D) -> void:
	var s := visual_scale
	_add_polygon(root, [Vector2(-58, 18), Vector2(58, 18), Vector2(50, 34), Vector2(-50, 34)] * s, Color("4d5352"), -4)
	_add_polygon(root, [Vector2(-39, 21), Vector2(39, 21), Vector2(33, 31), Vector2(-33, 31)] * s, Color("666d6b"), -3)
	_add_line(root, [Vector2(-52, 27), Vector2(-40, 19), Vector2(-30, 16)], Color("3f7246"), 3.0 * s, -2)
	_add_line(root, [Vector2(52, 27), Vector2(40, 19), Vector2(30, 16)], Color("3f7246"), 3.0 * s, -2)
...
func _build_ruin_integration(root: Node2D) -> void:
	var s := visual_scale
	_add_polygon(root, [Vector2(-48, 20), Vector2(48, 20), Vector2(43, 33), Vector2(-43, 33)] * s, Color("48504e"), -4)
	_add_polygon(root, [Vector2(-52, 23), Vector2(-38, 20), Vector2(-34, 29), Vector2(-50, 31)] * s, Color("6b7270"), -2)
	_add_polygon(root, [Vector2(37, 21), Vector2(54, 24), Vector2(49, 31), Vector2(35, 28)] * s, Color("5a6260"), -2)
	_add_line(root, [Vector2(-44, 19), Vector2(-34, 13), Vector2(-27, 17)], Color("376b42"), 2.0 * s, -2)
	_add_line(root, [Vector2(45, 19), Vector2(36, 12), Vector2(29, 16)], Color("376b42"), 2.0 * s, -2)
...
func _build_neutral_integration(root: Node2D) -> void:
	var s := visual_scale
	_add_polygon(root, [Vector2(-42, 19), Vector2(42, 19), Vector2(38, 29), Vector2(-38, 29)] * s, Color(0.12, 0.18, 0.16, 0.72), -4)
