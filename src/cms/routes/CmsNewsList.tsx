...
const copy = {
  es: {
    ...
    categories: { gaming: 'Gaming', tech: 'Tecnología', science: 'Ciencia', ai: 'IA', community: 'Comunidad', green: 'Green Node', programming: 'Programación', comicon: 'Universo COMICON' } as Record<string, string>,
  ...
  en: {
    ...
    categories: { gaming: 'Gaming', tech: 'Technology', science: 'Science', ai: 'AI', community: 'Community', green: 'Green Node', programming: 'Programming', comicon: 'COMICON Universe' } as Record<string, string>,
