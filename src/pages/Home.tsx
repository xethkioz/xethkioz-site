...
const portals: PortalNode[] = [
  ...
  },
  {
    ...
    route: '/fun',
    cta: 'ACTIVAR CAOS',
    description: 'Memes, clips, humor y contenido disruptivo.',
    scene: 'urban',
  },
]
  ...
  return (
    <>
      <SEO
        ...
        description="Interfaz AAA de XETHKIOZ con portales de Games, Science & Technology, Fun/Memes y Green Wisp."
        url="/"
        ...
        <main className="relative z-10 mx-auto grid min-h-[calc(100svh-220px)] max-w-[1660px] grid-cols-1 items-center gap-8 xl:grid-cols-[1fr_320px]">
          <section className="flex flex-col gap-8">
            <div className="max-w-4xl">
              <p className="font-mono text-[11px] font-black uppercase tracking-[0.38em] text-[#32FF8A]">XETHKIOZ NEXUS // AAA PORTAL UI</p>
