...
const articles: Record<Lang, FusionArticle[]> = {
  es: [
    ...
    { id: 'g-002', portal: 'gaming', title: 'Cómo cubrir un directo sin romper la web', summary: 'Estructura para integrar YouTube y clips sin convertir la página en un muro de embeds pesados.', category: 'Streaming', source: 'Live Ops', status: 'review', readMinutes: 3, xp: 25 },
  ...
  en: [
    ...
    { id: 'g-002', portal: 'gaming', title: 'How to cover a livestream without breaking the site', summary: 'Structure for YouTube and clips without turning the page into a heavy embed wall.', category: 'Streaming', source: 'Live Ops', status: 'review', readMinutes: 3, xp: 25 },
