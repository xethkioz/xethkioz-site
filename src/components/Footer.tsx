...
export default function Footer() {
  const { t } = useLang()
  const quickLinks = [{ to: '/news', label: t.nav.news }, { to: '/streaming', label: t.nav.streaming }, { to: '/media', label: t.nav.media }, { to: '/community', label: t.nav.community }, { to: '/about', label: t.nav.about }, { to: '/contact', label: t.nav.contact }, { to: '/support', label: 'Apoyar / Sponsors' }, { to: '/authors', label: t.author.title }, { to: '/cms', label: 'CMS Studio' }, { to: '/milestones', label: 'Milestones' }, { to: '/live-checklist', label: 'Checklist LIVE' }]
  const portals = [{ to: '/network', label: 'XETHKIOZ Network' }, { to: '/milestones', label: 'Milestones' }, { to: '/gaming', label: t.nav.gaming }, { to: '/tech', label: t.nav.tech }, { to: '/science', label: t.nav.science }, { to: '/ai-lab', label: 'AI Lab' }, { to: '/creator-studio', label: 'Creator Studio' }, { to: '/green-node', label: 'Green Node' }]
