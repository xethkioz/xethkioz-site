...
const copy = {
  es: {
    description: 'Gaming, tecnología, ciencia, comunidad, bienestar animal y archivos extraños conectados por una Red de Portales independiente creada en Argentina.',
  ...
  en: {
    description: 'Gaming, technology, science, community, animal welfare and unusual archives connected through an independent Portal Network created in Argentina.',
