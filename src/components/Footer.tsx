...
const copy = {
  es: { tagline: 'GAMING · TECNOLOGÍA · NOTICIAS', statement: 'BEYOND THE GAME', legal: 'Todos los derechos reservados.', about: 'Quiénes somos', support: 'Apoyar', editorial: 'Editorial', privacy: 'Privacidad', privacySettings: 'Cookies', contact: 'Contacto' },
  en: { tagline: 'GAMING · TECHNOLOGY · NEWS', statement: 'BEYOND THE GAME', legal: 'All rights reserved.', about: 'About', support: 'Support', editorial: 'Editorial', privacy: 'Privacy', privacySettings: 'Cookies', contact: 'Contact' },
} as const
