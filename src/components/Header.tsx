...
return (
<header
className={"fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${ scrolled ? 'glass-strong shadow-lg shadow-black/50 border-b border-white/10' : 'bg-transparent' }"}
>
    ...
    {mobileOpen && (
      <nav className="lg:hidden pb-4 animate-fade-in">
        <div className="flex flex-col gap-0.5 glass-strong rounded-lg p-3 border border-white/10">
          ...
          <NavLink
            to="/admin"
            className="px-4 py-2.5 text-sm font-medium rounded-md text-gray-500 hover:text-neon hover:bg-white/5 transition-all"
          >
            {t.nav.admin}
          </NavLink>
