  ...
  es: {
    fun: {
      ...
      steps: [
        ...
        { destination: 'play', energy: 'joy', eyebrow: 'MODO JUEGO // PLAZA NEXUS', title: 'Entrá a jugar y explorá la ciudad cuando quieras', description: 'La puerta principal abre la experiencia jugable. Nexus City permanece cerrada hasta que decidas explorarla, para que la página no cargue todo al mismo tiempo.', tip: 'Usá “Explorar Nexus City” para abrir la zona social completa; podés volver a cerrarla desde el mismo control.' },
        { destination: 'memes-home', energy: 'light', eyebrow: 'MEME CORE // PORTADA', title: 'La portada te muestra las rutas del caos', description: 'Acá vas a encontrar accesos rápidos al clip semanal, al muro de memes y a la comunidad. Es el mapa inicial antes de elegir una actividad.', tip: 'Cada subsección se carga por separado: Portada, Arcade, Clips y Muro.' },
  ...
  en: {
    fun: {
      ...
      steps: [
        ...
        { destination: 'play', energy: 'joy', eyebrow: 'GAME MODE // NEXUS PLAZA', title: 'Play first and explore the city when you want', description: 'The main gateway opens the playable experience. Nexus City stays closed until you choose to explore it, so the page does not load everything at once.', tip: 'Use “Explore Nexus City” to open the full social area and the same control to close it.' },
        { destination: 'memes-home', energy: 'light', eyebrow: 'MEME CORE // HOME', title: 'The home screen maps the routes into chaos', description: 'Find quick access to the weekly clip, meme wall and community before choosing an activity.', tip: 'Each subsection loads separately: Home, Arcade, Clips and Wall.' },
