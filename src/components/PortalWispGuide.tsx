...
const copy: Record<'es' | 'en', Record<PortalWispVariant, GuideCopy>> = {
  es: {
    ...
    gaming: {
      ...
      steps: [
        { destination: 'overview', energy: 'arcane', eyebrow: 'NÚCLEO ARCANO // MAPA DEL PORTAL', title: 'Tres energías para recorrer Gaming', description: 'Fuego detecta novedades, Arcano organiza guías y builds, e Hielo acompaña las rutas sociales y de comunidad.', tip: 'El color cambia con la explicación: cada elemento representa un tipo de contenido.' },
        { destination: 'overview', energy: 'ice', eyebrow: 'INICIO // ELEGÍ UNA RUTA', title: 'La portada abre sólo lo que necesitás', description: 'Desde Inicio podés ir a Guías, Radar o Comunidad. Cada ruta mantiene un propósito claro y evita bloques sin uso.', tip: 'Esto mantiene Gaming claro y rápido tanto en PC como en celular.' },
        ...
        { destination: 'news', energy: 'fire', eyebrow: 'FUEGO // RADAR XETHKIOZ', title: 'Seguí novedades y avances desde las redes oficiales', description: 'Threads concentra señales rápidas y conversación; Instagram reúne el costado visual y las publicaciones destacadas de XETHKIOZ.', tip: 'Usá siempre los perfiles oficiales enlazados desde la web.' },
        { destination: 'community', energy: 'ice', eyebrow: 'HIELO // COMUNIDAD', title: 'Acompañá el crecimiento de XETHKIOZ', description: 'La ruta de Comunidad conecta con Threads e Instagram para seguir, comentar y compartir el proyecto desde sus canales oficiales.', tip: 'El recorrido se guarda sólo en este dispositivo y podés reabrirlo tocando al Wisp Elemental.' },
      ],
    },
  },
  en: {
    ...
    gaming: {
      ...
      steps: [
        { destination: 'overview', energy: 'arcane', eyebrow: 'ARCANE CORE // PORTAL MAP', title: 'Three energies to navigate Gaming', description: 'Fire detects updates, Arcane organizes guides and builds, and Ice supports the social and community routes.', tip: 'Color changes with the explanation: each element represents a content type.' },
        { destination: 'overview', energy: 'ice', eyebrow: 'START // CHOOSE A ROUTE', title: 'The home screen opens only what you need', description: 'Start gives direct access to Guides, Radar and Community. Each route has one clear purpose and avoids unused sections.', tip: 'This keeps Gaming clear and fast on desktop and mobile.' },
        ...
        { destination: 'news', energy: 'fire', eyebrow: 'FIRE // XETHKIOZ RADAR', title: 'Follow updates through the official social channels', description: 'Threads carries fast signals and conversation; Instagram brings together the visual side and featured XETHKIOZ posts.', tip: 'Always use the official profiles linked from the website.' },
        { destination: 'community', energy: 'ice', eyebrow: 'ICE // COMMUNITY', title: 'Grow with XETHKIOZ', description: 'The Community route connects you with Threads and Instagram so you can follow, comment and share the project through its official channels.', tip: 'The tour stays on this device. Reopen it by tapping the Elemental Wisp.' },
      ],
    },
  },
}
