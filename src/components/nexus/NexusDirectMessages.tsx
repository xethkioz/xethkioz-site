...
const copy = {
  es: {
    ...
    empty: 'Todavía no tenés contactos aceptados. Las conversaciones privadas requieren contactos aceptados.',
  ...
  en: {
    ...
    empty: 'You have no accepted contacts yet. Private conversations require accepted contacts.',
